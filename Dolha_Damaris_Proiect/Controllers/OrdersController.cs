...
namespace Dolha_Damaris_Proiect.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var libraryContext = _context.Orders.Include(o => o.Customer).Include(o => o.Movie);
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderDate,CustomerId,MovieId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderDate,CustomerId,MovieId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
