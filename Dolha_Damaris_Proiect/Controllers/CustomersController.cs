...
namespace Dolha_Damaris_Proiect.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Address,BirthDate")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Address,BirthDate")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
